...
public class StoredAirMeasurementsControllerTestSuit {
    ...
    private final static String MAPPING = "/stored/air";

    @InjectMocks
    private StoredAirMeasurementsController controller;

    @Mock
    private StoredAirMeasurementsService service;
